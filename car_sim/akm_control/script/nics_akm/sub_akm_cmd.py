...
def set_mini_akm_velocity_steering(data):
    pub_vel_mini_akm_left_rear_wheel = rospy.Publisher('mini_akm_left_wheel_velocity_controller/command', Float64, queue_size=1)
    pub_vel_mini_akm_right_rear_wheel = rospy.Publisher('mini_akm_right_wheel_velocity_controller/command', Float64, queue_size=1)
    pub_pos_mini_akm_left_front_steering_hinge = rospy.Publisher('mini_akm_left_steering_hinge_position_controller/command', Float64, queue_size=1)
    pub_pos_mini_akm_right_front_steering_hinge = rospy.Publisher('mini_akm_right_steering_hinge_position_controller/command', Float64, queue_size=1)
    #cmd_vel linear.x
    v = data.linear.x
    #cmd_vel angular.z
    w = data.angular.z
