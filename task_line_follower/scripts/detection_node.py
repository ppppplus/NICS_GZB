...
class DetectNode:
    ...
    def __init__(self):
        ...
        rospy.loginfo('detection node set up.')
        self.image_topic = rospy.get_param("~image_topic", "/camera/zed/rgb/image_rect_color")
        self.image_ = None
        ...
        # 接收摄像头图像
        self.imageSub_ = rospy.Subscriber(self.image_topic, Image, self.imageCallback)  
        #发布车道线的横坐标
